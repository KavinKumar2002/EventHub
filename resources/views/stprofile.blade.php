              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="{{ asset($profile->image) }}" alt="Admin" class="square-circle" width="100">
                    <div class="mt-3">
                      <h4>{{$profile->name}}</h4>
                      
                      <p class="text-muted font-size-sm">{{$profile->address}}</p>
                      <a class="btn btn-primary" href="StudentimageEdit/{{$profile->email}}">Edit Profile Image</a>
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <div class="row" style="margin:10px">
                    <div class="col-sm-12">
                      <a class="btn btn-info " href="/StudentSocialedit/{{$profile->email}}">Edit</a>
                    </div>
                  </div>
              </div>
            </div>
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">University Register Number</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    {{$profile->regno}}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0">Current pursuing Year</h6>
                    </div>
                    <div class="col-sm-9 text-secondary">
                    {{$profile->year}}
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <a class="btn btn-info " target="__blank" href="/StudentProfileedit/{{$profile->email}}">Edit</a>
                    </div>
                  </div>
                </div>
              </div>
